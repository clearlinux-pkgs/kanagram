...
Version  : 23.04.2
Release  : 54
URL      : https://download.kde.org/stable/release-service/23.04.2/src/kanagram-23.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/kanagram-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/kanagram-23.04.2.tar.xz.sig
...
%prep
%setup -q -n kanagram-23.04.2
cd %{_builddir}/kanagram-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686520442
mkdir -p clr-build
pushd clr-build
